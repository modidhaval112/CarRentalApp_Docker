													...
													<Table class="table table-striped dataTable"
														...
														<tbody>
															<c:forEach var="transactionListValue"
																...
																<c:choose>
																	<c:when
																		test="${transactionListValue.status == 'Rented' || transactionListValue.status == 'Reserved'}">
																				...
																				<s:form method="post" id="myForm"
																					...
																					<div class="form-group">
																						<label for="clientName">Reserved/Rented by
																							Client</label> <input class="form-control"
																							id="clientName" readonly="true" name="clientName"
