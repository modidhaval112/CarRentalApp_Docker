 ...
 * 
 * @SpringBootTest public class ClientTests {
 * 
...
/*
 * 
 * @Test public void addNewClient() throws Exception { ClientRecord clientRecord
 * = new ClientRecord("T-1234-123456-12", "Johny", "Tester", "(438) 566-9999",
...
/*
 * 
 * @Test public void clientRecordCheck() throws Exception { ClientRecord
 * clientRecord = new ClientRecord("T-1234-123456-12", "Johny", "Tester",
 * "(438) 566-9999", "2059-10-31");
 * clientController.addClientRecord(clientRecord); clientRecord =
 * clientController.searchClient("T-1234-123456-12");
 * 
 * Assert.assertEquals("T-1234-123456-12",
 * clientRecord.getDriversLicenseNumber()); Assert.assertEquals("Johny",
 * clientRecord.getFirstName()); Assert.assertEquals("Tester",
 * clientRecord.getLastName()); Assert.assertEquals("(438) 566-9999",
 * clientRecord.getPhoneNumber()); }
 * 
 *//**
	 * Check for the deletion of the client record
	 *//*
		 * @Test public void deleteClient() throws Exception { ClientRecord clientRecord
		 * = new ClientRecord("T-1234-123456-12", "Johny", "Tester", "(438) 566-9999",
		 * "2059-10-31"); clientController.addClientRecord(clientRecord);
		 * Assert.assertTrue(clientController.getAllClientRecord().size() == 6);
